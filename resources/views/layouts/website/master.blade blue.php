...
<head>
    ...
    <style>
        :root {
            ...
            --aqua: #60a5fa;
            /* ACCENT COLOR (Sky Blue Highlight) */
            --soft-green: #10b981;
            /* Precise Green */

            --bg-light: #ffffff;
            /* Pure Clinical Surface */
            --text-dark: #1e293b;
            /* Deep Slate */
            --text-muted: #475569;
        }
        ...
        .hero-slide::before {
            ...
            right: 0;
            bottom: 0;
            /* Deep Oceanic Gradient: Royal Blue to Sky Hint */
            background: linear-gradient(135deg, rgba(37, 99, 235, 0.8) 0%, rgba(96, 165, 250, 0.2) 100%);
            z-index: 1;
        }
