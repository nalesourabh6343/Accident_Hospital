...
<head>
    ...
    <style>
        :root {
            /* Branding: Slate Charcoal & Soft Copper (Modern Luxury Theme) */
            --primary: #1f2933;
            /* Slate Charcoal */
            --primary-dark: #111827;

            --teal: #1f2933;
            /* MAIN BRAND COLOR (Slate) */
            --teal-light: #323f4b;
            /* Lighter Slate */

            --aqua: #c2410c;
            /* ACCENT COLOR (Soft Copper) */
            --soft-green: #ea580c;
            /* Vibrant Copper */
        ...
        .bg-teal-subtle {
            background-color: rgba(31, 41, 51, 0.06) !important;
        }
        ...
        .contact-info-card {
            ...
            box-shadow: 0 10px 40px rgba(31, 41, 51, 0.04);
        ...
        .navbar.scrolled {
            ...
            backdrop-filter: blur(10px);
            box-shadow: 0 4px 25px rgba(31, 41, 51, 0.1);
            padding: 0.5rem 0;
            top: 4px !important;
        }
        ...
        .navbar-toggler:focus {
            box-shadow: 0 0 0 0.25rem rgba(194, 65, 12, 0.15);
        }
        ...
        .hero-slide::before {
            ...
            right: 0;
            bottom: 0;
            /* Luxury Gradient: Charcoal to Copper Tint */
            background: linear-gradient(135deg, rgba(17, 24, 39, 0.95) 0%, rgba(194, 65, 12, 0.3) 100%);
            z-index: 1;
        }
        ...
        .gallery-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(31, 41, 51, 0.9), rgba(194, 65, 12, 0.7));
            display: flex;
            align-items: center;
            justify-content: center;
            opacity: 0;
        ...
        .faq-accordion .accordion-item {
            ...
            overflow: hidden;
            box-shadow: 0 4px 15px rgba(31, 41, 51, 0.08);
            background: rgba(255, 255, 255, 0.9);
        }
