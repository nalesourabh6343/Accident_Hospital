...
<head>
    ...
    <style>
        :root {
            /* Branding: Nature's Healing Green (Professional Medical Theme) */
            --primary: #059669;
            /* Emerald Green */
            --primary-dark: #064e3b;

            --teal: #10b981;
            /* Jade Green - Brand Focus */
            --teal-light: #34d399;
            /* Mint Pulse */
        ...
        .contact-map-wrapper {
            border-radius: 30px;
            overflow: hidden;
            box-shadow: 0 20px 60px rgba(8, 145, 178, 0.06);
            height: 100%;
            min-height: 450px;
        }
        ...
        .navbar-toggler:focus {
            box-shadow: 0 0 0 0.25rem rgba(8, 145, 178, 0.1);
        }
        ...
        .hero-slide::before {
            ...
            right: 0;
            bottom: 0;
            /* Healing Gradient: Emerald to Mint Hint */
            background: linear-gradient(135deg, rgba(5, 150, 105, 0.8) 0%, rgba(52, 211, 153, 0.2) 100%);
            z-index: 1;
        }
        ...
        .gallery-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(16, 185, 129, 0.85), rgba(52, 211, 153, 0.7));
            display: flex;
            align-items: center;
            justify-content: center;
            opacity: 0;
        ...
        .testimonial-slider-card {
            ...
            border-radius: 28px;
            padding: 3rem;
            box-shadow: 0 10px 40px rgba(8, 145, 178, 0.06);
            position: relative;
            margin: 20px;
        }
        ...
        .protocol-step {
            ...
            box-shadow: 0 10px 30px rgba(5, 150, 105, 0.04);
            height: 100%;
            transition: all 0.3s ease;
        }
