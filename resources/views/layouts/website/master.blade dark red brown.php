...
<head>
    ...
    <style>
        :root {
            /* Branding: Warm Ivory & Medical Maroon (Trust + Authority Theme) */
            --primary: #7f1d1d;
            /* Medical Maroon */
            --primary-dark: #450a0a;

            --teal: #7f1d1d;
            /* MAIN BRAND COLOR (Maroon) */
            --teal-light: #991b1b;
            /* Lighter Maroon */
        ...
        .contact-info-card {
            ...
            border-radius: 28px;
            background: #fff;
            box-shadow: 0 10px 40px rgba(127, 29, 29, 0.04);
        ...
        .contact-form-wrapper {
            ...
            padding: 45px;
            border-radius: 30px;
            box-shadow: 0 20px 60px rgba(127, 29, 29, 0.06);
        ...
        .navbar.scrolled {
            ...
            box-shadow: 0 4px 25px rgba(127, 29, 29, 0.08);
            padding: 0.5rem 0;
            top: 4px !important;
        }
        ...
        .navbar-toggler:focus {
            box-shadow: 0 0 0 0.25rem rgba(127, 29, 29, 0.1);
        }
        ...
        .hero-slide::before {
            ...
            right: 0;
            bottom: 0;
            /* Trust Gradient: Deep Maroon to Amber Tint */
            background: linear-gradient(135deg, rgba(127, 29, 29, 0.9) 0%, rgba(180, 83, 9, 0.3) 100%);
            z-index: 1;
        }
        ...
        .service-card:hover {
            transform: translateY(-10px);
            box-shadow: 0 20px 40px rgba(127, 29, 29, 0.1);
        }
        ...
        .gallery-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(127, 29, 29, 0.8), rgba(180, 83, 9, 0.6));
            display: flex;
            align-items: center;
            justify-content: center;
            opacity: 0;
        ...
        .testimonial-slider-card {
            ...
            border-radius: 28px;
            padding: 3rem;
            box-shadow: 0 10px 40px rgba(127, 29, 29, 0.06);
            position: relative;
            margin: 20px;
        }
        ...
        .opd-schedule-wrapper {
            ...
            border-radius: 30px;
            overflow: hidden;
            box-shadow: 0 20px 50px rgba(127, 29, 29, 0.06);
            border: 1px solid rgba(127, 29, 29, 0.08);
        }
        ...
        .tech-overlay {
            ...
            right: 0;
            padding: 30px;
            background: linear-gradient(to top, rgba(127, 29, 29, 0.9) 0%, transparent 100%);
            color: #fff;
            transition: all 0.4s ease;
        }
        ...
        .faq-accordion .accordion-item {
            ...
            overflow: hidden;
            box-shadow: 0 4px 15px rgba(127, 29, 29, 0.05);
        }
